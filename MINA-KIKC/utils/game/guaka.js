...
class Scratch {
  ...
  start (obj) {
    ...
    //this.obj.startCallBack = obj.startGame
  }
  ...
  touchStart (e) {
    ...
    let _this = this
    console.log('touchStart  startGame_type:')
    let pos = _this.drawRect(e.touches[0].x, e.touches[0].y)
    _this.ctx.clearRect(pos[0] ,pos[1] , pos[2], pos[2]) 
    _this.ctx.draw(true)
