...
Page({
  ...
  onReady: function () {
    if(this._option.issub==='Y'){
      
      wx.setNavigationBarTitle({ title: '分销商粉丝' });
  ...
  initPage: function () {
    ...
    let data = {
      ...
      isdrp:'',
      prt_vip_id:_this._option.prt_vip_id
    }

    app.http.post('Mymember/getSubfriends', data, function (json) {
      wx.hideLoading();
      ...
      //   }
      // })
      console.log('getSubfriends json',json)
